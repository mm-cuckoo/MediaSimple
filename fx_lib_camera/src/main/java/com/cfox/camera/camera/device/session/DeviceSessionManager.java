...
public class DeviceSessionManager implements ISessionManager {
    ...
    public static ISessionManager getInstance(Context context) {
        if (mSessionManager == null) {
            synchronized (DeviceSessionManager.class) {
                if (mSessionManager == null) {
                    mSessionManager = new DeviceSessionManager(context);
                }
            }
        }
    ...
    public DeviceSession createSession(String sessionId) {
        ...
        if (mCameraSessionMap.containsKey(sessionId)) {
            ...
            session = new AbsDeviceSession(mContext);
        }
